CREATE SCHEMA IF NOT EXISTS afu_grundwasserschutz_oereb;
CREATE SEQUENCE afu_grundwasserschutz_oereb.t_ili2db_seq MINVALUE 1000000000000;;
-- Localisation_V1.LocalisedText
CREATE TABLE afu_grundwasserschutz_oereb.localisedtext (
...
CREATE INDEX artikelnummer__thema_themagesetz_artiklnr_idx ON afu_grundwasserschutz_oereb.artikelnummer_ ( thema_themagesetz_artikelnr );
COMMENT ON COLUMN afu_grundwasserschutz_oereb.artikelnummer_.thema_themagesetz_artikelnr IS 'Hinweis auf spezifische Artikel.';
...
CREATE INDEX multilingualblob_konfiguration_logo_bild_idx ON afu_grundwasserschutz_oereb.multilingualblob ( konfiguration_logo_bild );
...
CREATE INDEX themaref_konfigurtn_gmndmtrbk_thmen_idx ON afu_grundwasserschutz_oereb.themaref ( konfiguratn_gmndmtrebk_themen );
...
COMMENT ON COLUMN afu_grundwasserschutz_oereb.themaref.konfiguratn_gmndmtrebk_themen IS 'In der Gemeinde freigeschaltete OeREB-Themen';
...
;
CREATE INDEX transferstrktr_hnwsdfntion_t_basket_idx ON afu_grundwasserschutz_oereb.transferstruktur_hinweisdefinition ( t_basket );
...
;
CREATE INDEX transfrstrktrrndlgvrfnrung_t_basket_idx ON afu_grundwasserschutz_oereb.transferstruktur_grundlageverfeinerung ( t_basket );
...
;
CREATE INDEX transfrstrktrwsdfntndkment_t_basket_idx ON afu_grundwasserschutz_oereb.transferstruktur_hinweisdefinitiondokument ( t_basket );
...
CREATE TABLE afu_grundwasserschutz_oereb.konfiguration_dokumenttyptxt (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX konfiguration_dokmnttyptxt_t_basket_idx ON afu_grundwasserschutz_oereb.konfiguration_dokumenttyptxt ( t_basket );
CREATE INDEX konfiguration_dokmnttyptxt_t_datasetname_idx ON afu_grundwasserschutz_oereb.konfiguration_dokumenttyptxt ( t_datasetname );
COMMENT ON TABLE afu_grundwasserschutz_oereb.konfiguration_dokumenttyptxt IS 'Anzeigetexte für die Aufzählung DokumentTyp';
-- OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK
CREATE TABLE afu_grundwasserschutz_oereb.konfiguration_gemeindemitoerebk (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX konfiguration_gemendmtrebk_t_basket_idx ON afu_grundwasserschutz_oereb.konfiguration_gemeindemitoerebk ( t_basket );
CREATE INDEX konfiguration_gemendmtrebk_t_datasetname_idx ON afu_grundwasserschutz_oereb.konfiguration_gemeindemitoerebk ( t_datasetname );
COMMENT ON COLUMN afu_grundwasserschutz_oereb.konfiguration_gemeindemitoerebk.gemeinde IS 'BFS-Nr. der Gemeinde';
COMMENT ON COLUMN afu_grundwasserschutz_oereb.konfiguration_gemeindemitoerebk.grundlagedatenstand IS 'Stand der Grundlagedaten (AV)';
COMMENT ON COLUMN afu_grundwasserschutz_oereb.konfiguration_gemeindemitoerebk.bezeichnunguntereinheitgrundbuch IS 'z.B. "Untereinheit" oder "GB-Kreis"';
-- OeREBKRMkvs_V2_0.Konfiguration.Glossar
CREATE TABLE afu_grundwasserschutz_oereb.konfiguration_glossar (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,titel text NULL
...
;
CREATE INDEX konfiguration_glossar_t_basket_idx ON afu_grundwasserschutz_oereb.konfiguration_glossar ( t_basket );
CREATE INDEX konfiguration_glossar_t_datasetname_idx ON afu_grundwasserschutz_oereb.konfiguration_glossar ( t_datasetname );
-- OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis
CREATE TABLE afu_grundwasserschutz_oereb.konfiguration_grundbuchkreis (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX konfiguration_grndbchkreis_t_basket_idx ON afu_grundwasserschutz_oereb.konfiguration_grundbuchkreis ( t_basket );
CREATE INDEX konfiguration_grndbchkreis_t_datasetname_idx ON afu_grundwasserschutz_oereb.konfiguration_grundbuchkreis ( t_datasetname );
COMMENT ON COLUMN afu_grundwasserschutz_oereb.konfiguration_grundbuchkreis.nbident IS 'NBIdent gem. AV-Daten';
COMMENT ON COLUMN afu_grundwasserschutz_oereb.konfiguration_grundbuchkreis.aname IS 'Name des GB-Kreises';
COMMENT ON COLUMN afu_grundwasserschutz_oereb.konfiguration_grundbuchkreis.subkreis IS 'SubKreis gem. GB-Daten (eGRISDM/GBDBS)';
COMMENT ON COLUMN afu_grundwasserschutz_oereb.konfiguration_grundbuchkreis.los IS 'Los gem. GB-Daten (eGRISDM/GBDBS)';
-- OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt
CREATE TABLE afu_grundwasserschutz_oereb.konfiguration_grundstueckarttxt (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,acode varchar(255) NOT NULL
...
;
CREATE INDEX konfiguratin_grndstckrttxt_t_basket_idx ON afu_grundwasserschutz_oereb.konfiguration_grundstueckarttxt ( t_basket );
CREATE INDEX konfiguratin_grndstckrttxt_t_datasetname_idx ON afu_grundwasserschutz_oereb.konfiguration_grundstueckarttxt ( t_datasetname );
COMMENT ON TABLE afu_grundwasserschutz_oereb.konfiguration_grundstueckarttxt IS 'Anzeigetexte für die Aufzählung GrundstueckArt';
-- OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss
CREATE TABLE afu_grundwasserschutz_oereb.konfiguration_haftungsausschuss (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,titel text NULL
...
;
CREATE INDEX konfiguratin_hftngssschuss_t_basket_idx ON afu_grundwasserschutz_oereb.konfiguration_haftungsausschuss ( t_basket );
CREATE INDEX konfiguratin_hftngssschuss_t_datasetname_idx ON afu_grundwasserschutz_oereb.konfiguration_haftungsausschuss ( t_datasetname );
-- OeREBKRMkvs_V2_0.Konfiguration.Information
CREATE TABLE afu_grundwasserschutz_oereb.konfiguration_information (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,titel text NULL
...
;
CREATE INDEX konfiguration_information_t_basket_idx ON afu_grundwasserschutz_oereb.konfiguration_information ( t_basket );
CREATE INDEX konfiguration_information_t_datasetname_idx ON afu_grundwasserschutz_oereb.konfiguration_information ( t_datasetname );
COMMENT ON COLUMN afu_grundwasserschutz_oereb.konfiguration_information.auszugindex IS 'Ordnungszahl für die Sortierung im Auszug.';
-- OeREBKRMkvs_V2_0.Konfiguration.Logo
CREATE TABLE afu_grundwasserschutz_oereb.konfiguration_logo (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX konfiguration_logo_t_basket_idx ON afu_grundwasserschutz_oereb.konfiguration_logo ( t_basket );
CREATE INDEX konfiguration_logo_t_datasetname_idx ON afu_grundwasserschutz_oereb.konfiguration_logo ( t_datasetname );
COMMENT ON COLUMN afu_grundwasserschutz_oereb.konfiguration_logo.acode IS 'ch.plr, ch, ch.{kanton} oder ch.{bfsnr}';
-- OeREBKRMkvs_V2_0.Konfiguration.MapLayering
CREATE TABLE afu_grundwasserschutz_oereb.konfiguration_maplayering (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX konfiguration_maplayering_t_basket_idx ON afu_grundwasserschutz_oereb.konfiguration_maplayering ( t_basket );
CREATE INDEX konfiguration_maplayering_t_datasetname_idx ON afu_grundwasserschutz_oereb.konfiguration_maplayering ( t_datasetname );
-- OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt
CREATE TABLE afu_grundwasserschutz_oereb.konfiguration_rechtsstatustxt (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,acode varchar(255) NOT NULL
...
;
CREATE INDEX konfiguration_rchtssttstxt_t_basket_idx ON afu_grundwasserschutz_oereb.konfiguration_rechtsstatustxt ( t_basket );
CREATE INDEX konfiguration_rchtssttstxt_t_datasetname_idx ON afu_grundwasserschutz_oereb.konfiguration_rechtsstatustxt ( t_datasetname );
COMMENT ON TABLE afu_grundwasserschutz_oereb.konfiguration_rechtsstatustxt IS 'Anzeigetexte für die Aufzählung RechtsStatus';
-- OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme
CREATE TABLE afu_grundwasserschutz_oereb.metadatenkvs_datenaufnahme (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,datum date NOT NULL
...
;
CREATE INDEX metadatenkvs_datenaufnahme_t_basket_idx ON afu_grundwasserschutz_oereb.metadatenkvs_datenaufnahme ( t_basket );
CREATE INDEX metadatenkvs_datenaufnahme_t_datasetname_idx ON afu_grundwasserschutz_oereb.metadatenkvs_datenaufnahme ( t_datasetname );
CREATE INDEX metadatenkvs_datenaufnahme_zustaendigestelle_idx ON afu_grundwasserschutz_oereb.metadatenkvs_datenaufnahme ( zustaendigestelle );
COMMENT ON TABLE afu_grundwasserschutz_oereb.metadatenkvs_datenaufnahme IS 'Angaben zur Datenlieferung an die Katasterorganisation des Kantons.';
COMMENT ON COLUMN afu_grundwasserschutz_oereb.metadatenkvs_datenaufnahme.datum IS 'Zeitpunkt der Aufnahme oder der letzten Änderung der Daten';
COMMENT ON COLUMN afu_grundwasserschutz_oereb.metadatenkvs_datenaufnahme.datensatzidentifikation IS 'BasketId oder Dateiname oder vollständiger WFS-Request.';
-- OeREBKRMkvs_V2_0.Thema.Thema
CREATE TABLE afu_grundwasserschutz_oereb.thema_thema (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX thema_thema_t_basket_idx ON afu_grundwasserschutz_oereb.thema_thema ( t_basket );
CREATE INDEX thema_thema_t_datasetname_idx ON afu_grundwasserschutz_oereb.thema_thema ( t_datasetname );
COMMENT ON TABLE afu_grundwasserschutz_oereb.thema_thema IS 'Anzeigetexte für die Aufzählung Thema';
COMMENT ON COLUMN afu_grundwasserschutz_oereb.thema_thema.auszugindex IS 'Ordnungszahl für die Sortierung im Auszug. Bei Subthemen definiert die Ordnungszahl die Reihenfolge innerhalb des Themas.';
-- OeREBKRMkvs_V2_0.Thema.ThemaGesetz
CREATE TABLE afu_grundwasserschutz_oereb.thema_themagesetz (
  T_Id bigint PRIMARY KEY DEFAULT nextval('afu_grundwasserschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX thema_themagesetz_t_basket_idx ON afu_grundwasserschutz_oereb.thema_themagesetz ( t_basket );
CREATE INDEX thema_themagesetz_t_datasetname_idx ON afu_grundwasserschutz_oereb.thema_themagesetz ( t_datasetname );
CREATE INDEX thema_themagesetz_thema_idx ON afu_grundwasserschutz_oereb.thema_themagesetz ( thema );
CREATE INDEX thema_themagesetz_gesetz_idx ON afu_grundwasserschutz_oereb.thema_themagesetz ( gesetz );
...
;
CREATE INDEX T_ILI2DB_BASKET_dataset_idx ON afu_grundwasserschutz_oereb.t_ili2db_basket ( dataset );
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_DATASET (
  T_Id bigint PRIMARY KEY
  ,datasetName varchar(200) NULL
)
;
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_IMPORT (
  T_Id bigint PRIMARY KEY
...
;
CREATE INDEX T_ILI2DB_IMPORT_dataset_idx ON afu_grundwasserschutz_oereb.t_ili2db_import ( dataset );
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_IMPORT_BASKET (
  T_Id bigint PRIMARY KEY
...
;
CREATE INDEX T_ILI2DB_IMPORT_BASKET_importrun_idx ON afu_grundwasserschutz_oereb.t_ili2db_import_basket ( importrun );
CREATE INDEX T_ILI2DB_IMPORT_BASKET_basket_idx ON afu_grundwasserschutz_oereb.t_ili2db_import_basket ( basket );
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (
  thisClass varchar(1024) PRIMARY KEY
  ,baseClass varchar(1024) NULL
)
;
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (
  tag varchar(60) PRIMARY KEY
  ,setting varchar(1024) NULL
)
;
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (
  iliname varchar(1024) NOT NULL
  ,tag varchar(1024) NOT NULL
  ,setting varchar(1024) NOT NULL
)
;
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_MODEL (
...
;
CREATE TABLE afu_grundwasserschutz_oereb.chcantoncode (
...
;
CREATE TABLE afu_grundwasserschutz_oereb.rechtsstatus (
  itfCode integer PRIMARY KEY
  ,iliCode varchar(1024) NOT NULL
  ,seq integer NULL
  ,inactive boolean NOT NULL
...
;
CREATE TABLE afu_grundwasserschutz_oereb.grundstueckart (
  itfCode integer PRIMARY KEY
  ,iliCode varchar(1024) NOT NULL
  ,seq integer NULL
  ,inactive boolean NOT NULL
...
;
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (
  IliName varchar(1024) PRIMARY KEY
  ,SqlName varchar(1024) NOT NULL
)
;
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (
  IliName varchar(1024) NOT NULL
  ,SqlName varchar(1024) NOT NULL
...
;
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (
...
;
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (
  tablename varchar(255) NOT NULL
  ,tag varchar(1024) NOT NULL
  ,setting varchar(1024) NOT NULL
)
;
CREATE TABLE afu_grundwasserschutz_oereb.T_ILI2DB_META_ATTRS (
...
ALTER TABLE afu_grundwasserschutz_oereb.artikelnummer_ ADD CONSTRAINT artikelnummer__thema_themagesetz_artiklnr_fkey FOREIGN KEY ( thema_themagesetz_artikelnr ) REFERENCES afu_grundwasserschutz_oereb.thema_themagesetz DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE afu_grundwasserschutz_oereb.multilingualblob ADD CONSTRAINT multilingualblob_konfiguration_logo_bild_fkey FOREIGN KEY ( konfiguration_logo_bild ) REFERENCES afu_grundwasserschutz_oereb.konfiguration_logo DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE afu_grundwasserschutz_oereb.themaref ADD CONSTRAINT themaref_konfigurtn_gmndmtrbk_thmen_fkey FOREIGN KEY ( konfiguratn_gmndmtrebk_themen ) REFERENCES afu_grundwasserschutz_oereb.konfiguration_gemeindemitoerebk DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE afu_grundwasserschutz_oereb.transferstruktur_hinweisdefinitiondokument ADD CONSTRAINT transfrstrktrwsdfntndkment_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.transferstruktur_hinweisdefinitiondokument ADD CONSTRAINT transfrstrktrwsdfntndkment_hinweisdefinition_fkey FOREIGN KEY ( hinweisdefinition ) REFERENCES afu_grundwasserschutz_oereb.transferstruktur_hinweisdefinition DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_dokumenttyptxt ADD CONSTRAINT konfiguration_dokmnttyptxt_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_gemeindemitoerebk ADD CONSTRAINT konfiguration_gemendmtrebk_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_gemeindemitoerebk ADD CONSTRAINT konfiguration_gemndmtrebk_gemeinde_check CHECK( gemeinde BETWEEN 1 AND 9999);
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_glossar ADD CONSTRAINT konfiguration_glossar_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_grundbuchkreis ADD CONSTRAINT konfiguration_grndbchkreis_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_grundbuchkreis ADD CONSTRAINT konfiguratin_grndbchkreis_gemeinde_check CHECK( gemeinde BETWEEN 1 AND 9999);
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_grundstueckarttxt ADD CONSTRAINT konfiguratin_grndstckrttxt_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_haftungsausschuss ADD CONSTRAINT konfiguratin_hftngssschuss_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_information ADD CONSTRAINT konfiguration_information_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_information ADD CONSTRAINT konfiguration_information_auszugindex_check CHECK( auszugindex BETWEEN -1000 AND 1000);
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_logo ADD CONSTRAINT konfiguration_logo_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_maplayering ADD CONSTRAINT konfiguration_maplayering_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_maplayering ADD CONSTRAINT konfiguration_maplayering_layerindex_check CHECK( layerindex BETWEEN -1000 AND 1000);
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_maplayering ADD CONSTRAINT konfiguration_maplayering_layerdeckkraft_check CHECK( layerdeckkraft BETWEEN 0.0 AND 1.0);
ALTER TABLE afu_grundwasserschutz_oereb.konfiguration_rechtsstatustxt ADD CONSTRAINT konfiguration_rchtssttstxt_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.metadatenkvs_datenaufnahme ADD CONSTRAINT metadatenkvs_datenaufnahme_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.metadatenkvs_datenaufnahme ADD CONSTRAINT metadatenkvs_datenaufnahme_zustaendigestelle_fkey FOREIGN KEY ( zustaendigestelle ) REFERENCES afu_grundwasserschutz_oereb.amt_amt DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.thema_thema ADD CONSTRAINT thema_thema_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.thema_thema ADD CONSTRAINT thema_thema_auszugindex_check CHECK( auszugindex BETWEEN -1000 AND 1000);
ALTER TABLE afu_grundwasserschutz_oereb.thema_themagesetz ADD CONSTRAINT thema_themagesetz_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES afu_grundwasserschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.thema_themagesetz ADD CONSTRAINT thema_themagesetz_thema_fkey FOREIGN KEY ( thema ) REFERENCES afu_grundwasserschutz_oereb.thema_thema DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE afu_grundwasserschutz_oereb.thema_themagesetz ADD CONSTRAINT thema_themagesetz_gesetz_fkey FOREIGN KEY ( gesetz ) REFERENCES afu_grundwasserschutz_oereb.vorschriften_dokument DEFERRABLE INITIALLY DEFERRED;
...
;
CREATE UNIQUE INDEX T_ILI2DB_ATTRNAME_ColOwner_SqlName_key ON afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (ColOwner,SqlName)
;
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme','metadatenkvs_datenaufnahme');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK','konfiguration_gemeindemitoerebk');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.ZustaendigeStelleDatenAufnahme','metadatenkvs_zustaendigestelledatenaufnahme');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRM_V2_0.ArtikelNummer_','artikelnummer_');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis','konfiguration_grundbuchkreis');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt','konfiguration_grundstueckarttxt');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Logo','konfiguration_logo');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRM_V2_0.GrundstueckArt','grundstueckart');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema','thema_thema');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss','konfiguration_haftungsausschuss');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt','konfiguration_rechtsstatustxt');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar','konfiguration_glossar');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz','thema_themagesetz');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information','konfiguration_information');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt','konfiguration_dokumenttyptxt');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering','konfiguration_maplayering');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt.Titel','titel','konfiguration_dokumenttyptxt',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.Los','los','konfiguration_grundbuchkreis',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering.VerweisWMS','verweiswms','konfiguration_maplayering',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRM_V2_0.ArtikelNummer_.value','avalue','artikelnummer_',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering.LayerIndex','layerindex','konfiguration_maplayering',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema.SubCode','subcode','thema_thema',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema.Code','acode','thema_thema',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Logo.Bild','konfiguration_logo_bild','multilingualblob','konfiguration_logo');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar.Titel','titel','konfiguration_glossar',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss.Titel','titel','konfiguration_haftungsausschuss',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.NBIdent','nbident','konfiguration_grundbuchkreis',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema.Titel','titel','thema_thema',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK.GrundlagedatenMetadaten','grundlagedatenmetadaten','konfiguration_gemeindemitoerebk',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt.Code','acode','konfiguration_dokumenttyptxt',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar.Inhalt','inhalt','konfiguration_glossar',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering.LayerDeckkraft','layerdeckkraft','konfiguration_maplayering',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz.Thema','thema','thema_themagesetz','thema_thema');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Logo.Code','acode','konfiguration_logo',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt.Titel','titel','konfiguration_grundstueckarttxt',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.Name','aname','konfiguration_grundbuchkreis',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.Gemeinde','gemeinde','konfiguration_grundbuchkreis',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme.DatensatzIdentifikation','datensatzidentifikation','metadatenkvs_datenaufnahme',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK.Themen','konfiguratn_gmndmtrebk_themen','themaref','konfiguration_gemeindemitoerebk');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss.Inhalt','inhalt','konfiguration_haftungsausschuss',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK.Gemeinde','gemeinde','konfiguration_gemeindemitoerebk',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information.AuszugIndex','auszugindex','konfiguration_information',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.ZustaendigeStelleDatenAufnahme.ZustaendigeStelle','zustaendigestelle','metadatenkvs_datenaufnahme','amt_amt');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt.Code','acode','konfiguration_rechtsstatustxt',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme.Datum','datum','metadatenkvs_datenaufnahme',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.Kanton','kanton','konfiguration_grundbuchkreis',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema.AuszugIndex','auszugindex','thema_thema',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK.BezeichnungUntereinheitGrundbuch','bezeichnunguntereinheitgrundbuch','konfiguration_gemeindemitoerebk',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information.Titel','titel','konfiguration_information',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz.Gesetz','gesetz','thema_themagesetz','vorschriften_dokument');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information.Inhalt','inhalt','konfiguration_information',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.SubKreis','subkreis','konfiguration_grundbuchkreis',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz.ArtikelNr','thema_themagesetz_artikelnr','artikelnummer_','thema_themagesetz');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK.GrundlagedatenStand','grundlagedatenstand','konfiguration_gemeindemitoerebk',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt.Code','acode','konfiguration_grundstueckarttxt',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt.Titel','titel','konfiguration_rechtsstatustxt',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information.Inhalt','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.ZustaendigeStelleDatenAufnahme','ch.ehi.ili2db.inheritance','embedded');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRM_V2_0.ArtikelNummer_','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss.Inhalt','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Logo','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar.Inhalt','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.ZustaendigeStelleDatenAufnahme',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRM_V2_0.ArtikelNummer_',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Logo',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss',NULL);
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering',NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt',NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ZH',0,'ZH',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'BE',1,'BE',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'LU',2,'LU',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'UR',3,'UR',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SZ',4,'SZ',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'OW',5,'OW',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'NW',6,'NW',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'GL',7,'GL',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ZG',8,'ZG',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'FR',9,'FR',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SO',10,'SO',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'BS',11,'BS',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'BL',12,'BL',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SH',13,'SH',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'AR',14,'AR',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'AI',15,'AI',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SG',16,'SG',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'GR',17,'GR',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'AG',18,'AG',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'TG',19,'TG',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'TI',20,'TI',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'VD',21,'VD',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'VS',22,'VS',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'NE',23,'NE',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'GE',24,'GE',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.chcantoncode (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'JU',25,'JU',FALSE,NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'rm',3,'rm',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'en',4,'en',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'aa',5,'aa',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ab',6,'ab',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'af',7,'af',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'am',8,'am',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ar',9,'ar',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'as',10,'as',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ay',11,'ay',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'az',12,'az',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ba',13,'ba',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'be',14,'be',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'bg',15,'bg',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'bh',16,'bh',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'bi',17,'bi',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'bn',18,'bn',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'bo',19,'bo',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'br',20,'br',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ca',21,'ca',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'co',22,'co',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'cs',23,'cs',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'cy',24,'cy',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'da',25,'da',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'dz',26,'dz',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'el',27,'el',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'eo',28,'eo',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'es',29,'es',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'et',30,'et',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'eu',31,'eu',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'fa',32,'fa',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'fi',33,'fi',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'fj',34,'fj',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'fo',35,'fo',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'fy',36,'fy',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ga',37,'ga',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'gd',38,'gd',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'gl',39,'gl',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'gn',40,'gn',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'gu',41,'gu',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ha',42,'ha',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'he',43,'he',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'hi',44,'hi',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'hr',45,'hr',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'hu',46,'hu',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'hy',47,'hy',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ia',48,'ia',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'id',49,'id',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ie',50,'ie',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ik',51,'ik',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'is',52,'is',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'iu',53,'iu',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ja',54,'ja',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'jw',55,'jw',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ka',56,'ka',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'kk',57,'kk',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'kl',58,'kl',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'km',59,'km',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'kn',60,'kn',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ko',61,'ko',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ks',62,'ks',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ku',63,'ku',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ky',64,'ky',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'la',65,'la',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ln',66,'ln',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'lo',67,'lo',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'lt',68,'lt',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'lv',69,'lv',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'mg',70,'mg',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'mi',71,'mi',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'mk',72,'mk',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ml',73,'ml',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'mn',74,'mn',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'mo',75,'mo',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'mr',76,'mr',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ms',77,'ms',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'mt',78,'mt',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'my',79,'my',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'na',80,'na',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ne',81,'ne',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'nl',82,'nl',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'no',83,'no',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'oc',84,'oc',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'om',85,'om',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'or',86,'or',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'pa',87,'pa',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'pl',88,'pl',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ps',89,'ps',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'pt',90,'pt',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'qu',91,'qu',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'rn',92,'rn',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ro',93,'ro',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ru',94,'ru',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'rw',95,'rw',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sa',96,'sa',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sd',97,'sd',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sg',98,'sg',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sh',99,'sh',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'si',100,'si',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sk',101,'sk',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sl',102,'sl',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sm',103,'sm',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sn',104,'sn',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'so',105,'so',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sq',106,'sq',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sr',107,'sr',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ss',108,'ss',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'st',109,'st',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'su',110,'su',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sv',111,'sv',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'sw',112,'sw',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ta',113,'ta',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'te',114,'te',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'tg',115,'tg',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'th',116,'th',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ti',117,'ti',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'tk',118,'tk',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'tl',119,'tl',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'tn',120,'tn',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'to',121,'to',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'tr',122,'tr',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ts',123,'ts',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'tt',124,'tt',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'tw',125,'tw',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ug',126,'ug',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'uk',127,'uk',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'ur',128,'ur',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'uz',129,'uz',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'vi',130,'vi',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'vo',131,'vo',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'wo',132,'wo',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'xh',133,'xh',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'yi',134,'yi',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'yo',135,'yo',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'za',136,'za',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'zh',137,'zh',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.languagecode_iso639_1 (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'zu',138,'zu',FALSE,NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'Liegenschaft',0,'Liegenschaft',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SelbstRecht.Baurecht',1,'SelbstRecht.Baurecht',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SelbstRecht.Quellenrecht',2,'SelbstRecht.Quellenrecht',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SelbstRecht.Konzessionsrecht',3,'SelbstRecht.Konzessionsrecht',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SelbstRecht.weitere',4,'SelbstRecht.weitere',FALSE,NULL);
INSERT INTO afu_grundwasserschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'Bergwerk',5,'Bergwerk',FALSE,NULL);
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('transferstruktur_geometrie',NULL,'flaeche_lv95','ch.ehi.ili2db.geomType','POLYGON');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('transferstruktur_geometrie',NULL,'linie_lv95','ch.ehi.ili2db.geomType','LINESTRING');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('transferstruktur_geometrie',NULL,'linie_lv95','ch.ehi.ili2db.c1Min','2460000.000');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('transferstruktur_geometrie',NULL,'linie_lv95','ch.ehi.ili2db.c2Min','1045000.000');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('themaref',NULL,'konfiguratn_gmndmtrebk_themen','ch.ehi.ili2db.foreignKey','konfiguration_gemeindemitoerebk');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('thema_themagesetz',NULL,'gesetz','ch.ehi.ili2db.foreignKey','vorschriften_dokument');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('thema_themagesetz',NULL,'thema','ch.ehi.ili2db.foreignKey','thema_thema');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('multilingualblob',NULL,'konfiguration_logo_bild','ch.ehi.ili2db.foreignKey','konfiguration_logo');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('artikelnummer_',NULL,'thema_themagesetz_artikelnr','ch.ehi.ili2db.foreignKey','thema_themagesetz');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('metadatenkvs_datenaufnahme',NULL,'zustaendigestelle','ch.ehi.ili2db.foreignKey','amt_amt');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('multilingualmtext',NULL,'T_Type','ch.ehi.ili2db.types','["localisationch_v1_multilingualmtext","multilingualmtext"]');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('transferstruktur_geometrie',NULL,'punkt_lv95','ch.ehi.ili2db.geomType','POINT');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('thema_thema','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_dokumenttyptxt','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_logo','ch.ehi.ili2db.tableKind','CLASS');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_maplayering','ch.ehi.ili2db.tableKind','CLASS');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_grundbuchkreis','ch.ehi.ili2db.tableKind','CLASS');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_gemeindemitoerebk','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('metadatenkvs_datenaufnahme','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_haftungsausschuss','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_glossar','ch.ehi.ili2db.tableKind','CLASS');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('thema_themagesetz','ch.ehi.ili2db.tableKind','ASSOCIATION');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_grundstueckarttxt','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_rechtsstatustxt','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('grundstueckart','ch.ehi.ili2db.tableKind','ENUM');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_information','ch.ehi.ili2db.tableKind','CLASS');
...
END OeREBKRMvs_V2_0.
','2020-07-09 18:02:46.754');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('OeREBKRMkvs_V2_0.ili','2.3','OeREBKRMkvs_V2_0{ CHAdminCodes_V1 LocalisationCH_V1 OeREBKRM_V2_0 OeREBKRMvs_V2_0}','INTERLIS 2.3;
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.nameOptimization','topic');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.localisedTrafo','expand');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.numericCheckConstraints','create');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.sender','ili2pg-4.3.1-23b1f79e8ad644414773bb9bd1a97c8c265c5082');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.createForeignKey','yes');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.sqlgen.createGeomIndex','True');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.defaultSrsAuthority','EPSG');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.defaultSrsCode','2056');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.uuidDefaultValue','uuid_generate_v4()');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.StrokeArcs','enable');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.multiLineTrafo','coalesce');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.interlis.ili2c.ilidirs','models/;http://models.geo.admin.ch;https://geo.so.ch/models');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.createForeignKeyIndex','yes');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.importTabs','simple');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.createDatasetCols','addDatasetCol');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.jsonTrafo','coalesce');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.BasketHandling','readWrite');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.createEnumDefs','multiTable');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.uniqueConstraints','create');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.maxSqlNameLength','60');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.inheritanceTrafo','smart1');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.catalogueRefTrafo','coalesce');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.multiPointTrafo','coalesce');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.multiSurfaceTrafo','coalesce');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('DictionariesCH_V1','furtherInformation','http://www.geo.admin.ch/internet/geoportal/de/home/topics/geobasedata/models.html');
...
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('OeREBKRMkvs_V2_0','furtherInformation','https://www.cadastre.ch/oereb-public');
INSERT INTO afu_grundwasserschutz_oereb.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('OeREBKRMkvs_V2_0','technicalContact','mailto:vermessung@swisstopo.ch');
...
GRANT USAGE ON ALL SEQUENCES IN SCHEMA afu_grundwasserschutz_oereb TO :PG_WRITE_USER;
