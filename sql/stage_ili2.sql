...
-- OeREB_ExtractAnnex_V1_1.ThemaRef
CREATE TABLE stage.oereb_extractannex_v1_1_themaref (
  T_Id bigint PRIMARY KEY DEFAULT nextval('stage.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_Type varchar(60) NOT NULL
  ,T_Seq bigint NULL
...
;
CREATE INDEX oereb_xtrctnnx_v1_1_thmref_t_basket_idx ON stage.oereb_extractannex_v1_1_themaref ( t_basket );
CREATE INDEX oereb_xtrctnnx_v1_1_thmref_oerb_xtnx_vplwthplrc_thmes_idx ON stage.oereb_extractannex_v1_1_themaref ( oerb_xtnx_vpltywthplrc_themes );
-- OeREB_ExtractAnnex_V1_1.Annex.Logo
CREATE TABLE stage.oerb_xtnx_v1_1annex_logo (
  T_Id bigint PRIMARY KEY DEFAULT nextval('stage.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_Type varchar(60) NOT NULL
  ,T_Ili_Tid varchar(200) NULL
...
;
CREATE INDEX oerb_xtnx_v1_1annex_logo_t_basket_idx ON stage.oerb_xtnx_v1_1annex_logo ( t_basket );
COMMENT ON COLUMN stage.oerb_xtnx_v1_1annex_logo.acode IS 'ch.plr, ch, ch.so oder ch.bfsnr';
-- OeREB_ExtractAnnex_V1_1.Annex.MunicipalityWithPLRC
CREATE TABLE stage.oerb_xtnx_v1_1annex_municipalitywithplrc (
  T_Id bigint PRIMARY KEY DEFAULT nextval('stage.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_Type varchar(60) NOT NULL
  ,T_Ili_Tid varchar(200) NULL
...
;
CREATE INDEX oerb_xtnx_v1_ncpltywthplrc_t_basket_idx ON stage.oerb_xtnx_v1_1annex_municipalitywithplrc ( t_basket );
COMMENT ON COLUMN stage.oerb_xtnx_v1_1annex_municipalitywithplrc.municipality IS 'BFS-Nr.';
COMMENT ON COLUMN stage.oerb_xtnx_v1_1annex_municipalitywithplrc.basedatadate IS 'Stand der Grundlagedaten z.B. der AV';
-- OeREB_ExtractAnnex_V1_1.Annex.MapLayering
CREATE TABLE stage.oerb_xtnx_v1_1annex_maplayering (
  T_Id bigint PRIMARY KEY DEFAULT nextval('stage.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_Type varchar(60) NOT NULL
  ,T_Ili_Tid varchar(200) NULL
...
;
CREATE INDEX oerb_xtnx_v1_1nnx_mplyring_t_basket_idx ON stage.oerb_xtnx_v1_1annex_maplayering ( t_basket );
-- OeREB_ExtractAnnex_V1_1.Annex.Office
CREATE TABLE stage.oerb_xtnx_v1_1annex_office (
  T_Id bigint PRIMARY KEY DEFAULT nextval('stage.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_Type varchar(60) NOT NULL
  ,T_Ili_Tid varchar(200) NULL
...
;
CREATE INDEX oerb_xtnx_v1_1annex_office_t_basket_idx ON stage.oerb_xtnx_v1_1annex_office ( t_basket );
COMMENT ON COLUMN stage.oerb_xtnx_v1_1annex_office.officeatweb IS 'OfficeAtWeb wird für die Referenzierung verwendet!
solange UID nicht generell zugeordnet.';
COMMENT ON COLUMN stage.oerb_xtnx_v1_1annex_office.line1 IS 'Falls im statischen Auszug mehr Informationen angezeigt
...
-- OeREB_ExtractAnnex_V1_1.Annex.Glossary
CREATE TABLE stage.oerb_xtnx_v1_1annex_glossary (
  T_Id bigint PRIMARY KEY DEFAULT nextval('stage.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_Type varchar(60) NOT NULL
  ,T_Ili_Tid varchar(200) NULL
...
;
CREATE INDEX oerb_xtnx_v1_1annx_glssary_t_basket_idx ON stage.oerb_xtnx_v1_1annex_glossary ( t_basket );
-- OeREB_ExtractAnnex_V1_1.Annex.ExclusionOfLiability
CREATE TABLE stage.oerb_xtnx_v1_1annex_exclusionofliability (
  T_Id bigint PRIMARY KEY DEFAULT nextval('stage.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_Type varchar(60) NOT NULL
  ,T_Ili_Tid varchar(200) NULL
...
;
CREATE INDEX oerb_xtnx_v1__xclsnflblity_t_basket_idx ON stage.oerb_xtnx_v1_1annex_exclusionofliability ( t_basket );
-- OeREB_ExtractAnnex_V1_1.Annex.GeneralInformation
CREATE TABLE stage.oerb_xtnx_v1_1annex_generalinformation (
  T_Id bigint PRIMARY KEY DEFAULT nextval('stage.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_Type varchar(60) NOT NULL
  ,T_Ili_Tid varchar(200) NULL
...
;
CREATE INDEX oerb_xtnx_v1__gnrlnfrmtion_t_basket_idx ON stage.oerb_xtnx_v1_1annex_generalinformation ( t_basket );
-- OeREB_ExtractAnnex_V1_1.Annex.BaseData
CREATE TABLE stage.oerb_xtnx_v1_1annex_basedata (
  T_Id bigint PRIMARY KEY DEFAULT nextval('stage.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_Type varchar(60) NOT NULL
  ,T_Ili_Tid varchar(200) NULL
...
;
CREATE INDEX oerb_xtnx_v1_1annex_bsdata_t_basket_idx ON stage.oerb_xtnx_v1_1annex_basedata ( t_basket );
...
ALTER TABLE stage.oereb_extractannex_v1_1_themaref ADD CONSTRAINT oereb_xtrctnnx_v1_1_thmref_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES stage.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE stage.oereb_extractannex_v1_1_themaref ADD CONSTRAINT oereb_xtrctnnx_v1_1_thmref_oerb_xtnx_vplwthplrc_thmes_fkey FOREIGN KEY ( oerb_xtnx_vpltywthplrc_themes ) REFERENCES stage.oerb_xtnx_v1_1annex_municipalitywithplrc DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE stage.oerb_xtnx_v1_1annex_logo ADD CONSTRAINT oerb_xtnx_v1_1annex_logo_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES stage.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE stage.oerb_xtnx_v1_1annex_municipalitywithplrc ADD CONSTRAINT oerb_xtnx_v1_ncpltywthplrc_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES stage.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE stage.oerb_xtnx_v1_1annex_municipalitywithplrc ADD CONSTRAINT oerb_xtnx_v1ncpltywthplrc_municipality_check CHECK( municipality BETWEEN 1 AND 9999);
ALTER TABLE stage.oerb_xtnx_v1_1annex_maplayering ADD CONSTRAINT oerb_xtnx_v1_1nnx_mplyring_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES stage.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE stage.oerb_xtnx_v1_1annex_maplayering ADD CONSTRAINT oerb_xtnx_v11nnx_mplyring_layerindex_check CHECK( layerindex BETWEEN -1000 AND 1000);
ALTER TABLE stage.oerb_xtnx_v1_1annex_maplayering ADD CONSTRAINT oerb_xtnx_v11nnx_mplyring_layeropacity_check CHECK( layeropacity BETWEEN 0.0 AND 1.0);
ALTER TABLE stage.oerb_xtnx_v1_1annex_office ADD CONSTRAINT oerb_xtnx_v1_1annex_office_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES stage.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE stage.oerb_xtnx_v1_1annex_glossary ADD CONSTRAINT oerb_xtnx_v1_1annx_glssary_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES stage.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE stage.oerb_xtnx_v1_1annex_exclusionofliability ADD CONSTRAINT oerb_xtnx_v1__xclsnflblity_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES stage.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE stage.oerb_xtnx_v1_1annex_generalinformation ADD CONSTRAINT oerb_xtnx_v1__gnrlnfrmtion_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES stage.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE stage.oerb_xtnx_v1_1annex_basedata ADD CONSTRAINT oerb_xtnx_v1_1annex_bsdata_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES stage.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
...
INSERT INTO stage.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.ExclusionOfLiability','oerb_xtnx_v1_1annex_exclusionofliability');
...
INSERT INTO stage.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Logo','oerb_xtnx_v1_1annex_logo');
INSERT INTO stage.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.GeneralInformation','oerb_xtnx_v1_1annex_generalinformation');
...
INSERT INTO stage.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MapLayering','oerb_xtnx_v1_1annex_maplayering');
INSERT INTO stage.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office','oerb_xtnx_v1_1annex_office');
...
INSERT INTO stage.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.BaseData','oerb_xtnx_v1_1annex_basedata');
...
INSERT INTO stage.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MunicipalityWithPLRC','oerb_xtnx_v1_1annex_municipalitywithplrc');
...
INSERT INTO stage.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Glossary','oerb_xtnx_v1_1annex_glossary');
INSERT INTO stage.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREB_ExtractAnnex_V1_1.ThemaRef','oereb_extractannex_v1_1_themaref');
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.ExclusionOfLiability.Content','content','oerb_xtnx_v1_1annex_exclusionofliability',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Glossary.Title','title','oerb_xtnx_v1_1annex_glossary',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office.Line2','line2','oerb_xtnx_v1_1annex_office',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.ExclusionOfLiability.Title','title','oerb_xtnx_v1_1annex_exclusionofliability',NULL);
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office.Name','aname','oerb_xtnx_v1_1annex_office',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office.PostalCode','postalcode','oerb_xtnx_v1_1annex_office',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.BaseData.Content','content','oerb_xtnx_v1_1annex_basedata',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office.UID','auid','oerb_xtnx_v1_1annex_office',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Logo.logo','logo','oerb_xtnx_v1_1annex_logo',NULL);
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MunicipalityWithPLRC.metadataOfGeographicalBaseData','metadataofgeographicalbasedata','oerb_xtnx_v1_1annex_municipalitywithplrc',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office.City','city','oerb_xtnx_v1_1annex_office',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.ThemaRef.SubThema','subthema','oereb_extractannex_v1_1_themaref',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.GeneralInformation.Content','content','oerb_xtnx_v1_1annex_generalinformation',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MunicipalityWithPLRC.baseDataDate','basedatadate','oerb_xtnx_v1_1annex_municipalitywithplrc',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Glossary.Content','content','oerb_xtnx_v1_1annex_glossary',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office.Street','street','oerb_xtnx_v1_1annex_office',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRM_V1_1.CodelistenText.ThemaTxt.SubThema','subthema','oerebkrm_v1_1codelistentext_thematxt',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MapLayering.webservice','webservice','oerb_xtnx_v1_1annex_maplayering',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MunicipalityWithPLRC.municipality','municipality','oerb_xtnx_v1_1annex_municipalitywithplrc',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Logo.code','acode','oerb_xtnx_v1_1annex_logo',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MapLayering.layerOpacity','layeropacity','oerb_xtnx_v1_1annex_maplayering',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MapLayering.layerIndex','layerindex','oerb_xtnx_v1_1annex_maplayering',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.ThemaRef.Thema','thema','oereb_extractannex_v1_1_themaref',NULL);
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MunicipalityWithPLRC.themes','oerb_xtnx_vpltywthplrc_themes','oereb_extractannex_v1_1_themaref','oerb_xtnx_v1_1annex_municipalitywithplrc');
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office.Line1','line1','oerb_xtnx_v1_1annex_office',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office.Number','anumber','oerb_xtnx_v1_1annex_office',NULL);
...
INSERT INTO stage.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office.OfficeAtWeb','officeatweb','oerb_xtnx_v1_1annex_office',NULL);
...
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.ExclusionOfLiability','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.BaseData.Content','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Logo','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.GeneralInformation','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MapLayering','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Glossary.Content','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office.Name','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.BaseData','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MunicipalityWithPLRC','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.ExclusionOfLiability.Title','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Glossary','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.ThemaRef','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.GeneralInformation.Content','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Glossary.Title','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO stage.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.ExclusionOfLiability.Content','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO stage.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Office',NULL);
...
INSERT INTO stage.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Glossary',NULL);
...
INSERT INTO stage.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MapLayering',NULL);
...
INSERT INTO stage.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.Logo',NULL);
...
INSERT INTO stage.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREB_ExtractAnnex_V1_1.ThemaRef',NULL);
...
INSERT INTO stage.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.ExclusionOfLiability',NULL);
...
INSERT INTO stage.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.MunicipalityWithPLRC',NULL);
...
INSERT INTO stage.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.BaseData',NULL);
...
INSERT INTO stage.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREB_ExtractAnnex_V1_1.Annex.GeneralInformation',NULL);
...
INSERT INTO stage.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('oereb_extractannex_v1_1_themaref',NULL,'oerb_xtnx_vpltywthplrc_themes','ch.ehi.ili2db.foreignKey','oerb_xtnx_v1_1annex_municipalitywithplrc');
...
INSERT INTO stage.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('oereb_extractannex_v1_1_themaref',NULL,'T_Type','ch.ehi.ili2db.types','["oereb_extractannex_v1_1_themaref"]');
...
INSERT INTO stage.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('oerb_xtnx_v1_1annex_generalinformation',NULL,'T_Type','ch.ehi.ili2db.types','["oerb_xtnx_v1_1annex_generalinformation"]');
...
INSERT INTO stage.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('oerb_xtnx_v1_1annex_exclusionofliability',NULL,'T_Type','ch.ehi.ili2db.types','["oerb_xtnx_v1_1annex_exclusionofliability"]');
...
INSERT INTO stage.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('oerb_xtnx_v1_1annex_basedata',NULL,'T_Type','ch.ehi.ili2db.types','["oerb_xtnx_v1_1annex_basedata"]');
...
INSERT INTO stage.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('oerb_xtnx_v1_1annex_maplayering',NULL,'T_Type','ch.ehi.ili2db.types','["oerb_xtnx_v1_1annex_maplayering"]');
...
INSERT INTO stage.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('oerb_xtnx_v1_1annex_glossary',NULL,'T_Type','ch.ehi.ili2db.types','["oerb_xtnx_v1_1annex_glossary"]');
...
INSERT INTO stage.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('oerb_xtnx_v1_1annex_office',NULL,'T_Type','ch.ehi.ili2db.types','["oerb_xtnx_v1_1annex_office"]');
...
INSERT INTO stage.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('oerb_xtnx_v1_1annex_municipalitywithplrc',NULL,'T_Type','ch.ehi.ili2db.types','["oerb_xtnx_v1_1annex_municipalitywithplrc"]');
...
INSERT INTO stage.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('oerb_xtnx_v1_1annex_logo',NULL,'T_Type','ch.ehi.ili2db.types','["oerb_xtnx_v1_1annex_logo"]');
...
INSERT INTO stage.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('oerb_xtnx_v1_1annex_maplayering','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO stage.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('oerb_xtnx_v1_1annex_glossary','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO stage.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('oerb_xtnx_v1_1annex_municipalitywithplrc','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO stage.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('oerb_xtnx_v1_1annex_generalinformation','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO stage.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('oereb_extractannex_v1_1_themaref','ch.ehi.ili2db.tableKind','STRUCTURE');
...
INSERT INTO stage.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('oerb_xtnx_v1_1annex_office','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO stage.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('oerb_xtnx_v1_1annex_exclusionofliability','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO stage.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('oerb_xtnx_v1_1annex_logo','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO stage.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('oerb_xtnx_v1_1annex_basedata','ch.ehi.ili2db.tableKind','CLASS');
...
!! ########################################################################
','2020-05-20 10:39:06.213');
INSERT INTO stage.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('OeREB_ExtractAnnex_V1_1.ili','2.3','OeREB_ExtractAnnex_V1_1{ CHAdminCodes_V1 LocalisationCH_V1 OeREBKRM_V1_1 CatalogueObjects_V1}','INTERLIS 2.3;
...
-- INSERT INTO stage.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.interlis.ili2c.ilidirs','models/;http://models.geo.admin.ch;https://geo-t.so.ch/models');
