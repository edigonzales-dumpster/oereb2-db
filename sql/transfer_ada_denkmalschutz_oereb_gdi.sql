...
CREATE INDEX artikelnummer__thema_themagesetz_artiklnr_idx ON ada_denkmalschutz_oereb.artikelnummer_ ( thema_themagesetz_artikelnr );
COMMENT ON COLUMN ada_denkmalschutz_oereb.artikelnummer_.thema_themagesetz_artikelnr IS 'Hinweis auf spezifische Artikel.';
...
CREATE INDEX multilingualblob_konfiguration_logo_bild_idx ON ada_denkmalschutz_oereb.multilingualblob ( konfiguration_logo_bild );
...
CREATE INDEX themaref_konfigurtn_gmndmtrbk_thmen_idx ON ada_denkmalschutz_oereb.themaref ( konfiguratn_gmndmtrebk_themen );
...
COMMENT ON COLUMN ada_denkmalschutz_oereb.themaref.konfiguratn_gmndmtrebk_themen IS 'In der Gemeinde freigeschaltete OeREB-Themen';
...
CREATE TABLE ada_denkmalschutz_oereb.konfiguration_dokumenttyptxt (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX konfiguration_dokmnttyptxt_t_basket_idx ON ada_denkmalschutz_oereb.konfiguration_dokumenttyptxt ( t_basket );
CREATE INDEX konfiguration_dokmnttyptxt_t_datasetname_idx ON ada_denkmalschutz_oereb.konfiguration_dokumenttyptxt ( t_datasetname );
COMMENT ON TABLE ada_denkmalschutz_oereb.konfiguration_dokumenttyptxt IS 'Anzeigetexte für die Aufzählung DokumentTyp';
-- OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK
CREATE TABLE ada_denkmalschutz_oereb.konfiguration_gemeindemitoerebk (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX konfiguration_gemendmtrebk_t_basket_idx ON ada_denkmalschutz_oereb.konfiguration_gemeindemitoerebk ( t_basket );
CREATE INDEX konfiguration_gemendmtrebk_t_datasetname_idx ON ada_denkmalschutz_oereb.konfiguration_gemeindemitoerebk ( t_datasetname );
COMMENT ON COLUMN ada_denkmalschutz_oereb.konfiguration_gemeindemitoerebk.gemeinde IS 'BFS-Nr. der Gemeinde';
COMMENT ON COLUMN ada_denkmalschutz_oereb.konfiguration_gemeindemitoerebk.grundlagedatenstand IS 'Stand der Grundlagedaten (AV)';
COMMENT ON COLUMN ada_denkmalschutz_oereb.konfiguration_gemeindemitoerebk.bezeichnunguntereinheitgrundbuch IS 'z.B. "Untereinheit" oder "GB-Kreis"';
-- OeREBKRMkvs_V2_0.Konfiguration.Glossar
CREATE TABLE ada_denkmalschutz_oereb.konfiguration_glossar (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,titel text NULL
...
;
CREATE INDEX konfiguration_glossar_t_basket_idx ON ada_denkmalschutz_oereb.konfiguration_glossar ( t_basket );
CREATE INDEX konfiguration_glossar_t_datasetname_idx ON ada_denkmalschutz_oereb.konfiguration_glossar ( t_datasetname );
-- OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis
CREATE TABLE ada_denkmalschutz_oereb.konfiguration_grundbuchkreis (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX konfiguration_grndbchkreis_t_basket_idx ON ada_denkmalschutz_oereb.konfiguration_grundbuchkreis ( t_basket );
CREATE INDEX konfiguration_grndbchkreis_t_datasetname_idx ON ada_denkmalschutz_oereb.konfiguration_grundbuchkreis ( t_datasetname );
COMMENT ON COLUMN ada_denkmalschutz_oereb.konfiguration_grundbuchkreis.nbident IS 'NBIdent gem. AV-Daten';
COMMENT ON COLUMN ada_denkmalschutz_oereb.konfiguration_grundbuchkreis.aname IS 'Name des GB-Kreises';
COMMENT ON COLUMN ada_denkmalschutz_oereb.konfiguration_grundbuchkreis.subkreis IS 'SubKreis gem. GB-Daten (eGRISDM/GBDBS)';
COMMENT ON COLUMN ada_denkmalschutz_oereb.konfiguration_grundbuchkreis.los IS 'Los gem. GB-Daten (eGRISDM/GBDBS)';
-- OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt
CREATE TABLE ada_denkmalschutz_oereb.konfiguration_grundstueckarttxt (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,acode varchar(255) NOT NULL
...
;
CREATE INDEX konfiguratin_grndstckrttxt_t_basket_idx ON ada_denkmalschutz_oereb.konfiguration_grundstueckarttxt ( t_basket );
CREATE INDEX konfiguratin_grndstckrttxt_t_datasetname_idx ON ada_denkmalschutz_oereb.konfiguration_grundstueckarttxt ( t_datasetname );
COMMENT ON TABLE ada_denkmalschutz_oereb.konfiguration_grundstueckarttxt IS 'Anzeigetexte für die Aufzählung GrundstueckArt';
-- OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss
CREATE TABLE ada_denkmalschutz_oereb.konfiguration_haftungsausschuss (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,titel text NULL
...
;
CREATE INDEX konfiguratin_hftngssschuss_t_basket_idx ON ada_denkmalschutz_oereb.konfiguration_haftungsausschuss ( t_basket );
CREATE INDEX konfiguratin_hftngssschuss_t_datasetname_idx ON ada_denkmalschutz_oereb.konfiguration_haftungsausschuss ( t_datasetname );
-- OeREBKRMkvs_V2_0.Konfiguration.Information
CREATE TABLE ada_denkmalschutz_oereb.konfiguration_information (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,titel text NULL
...
;
CREATE INDEX konfiguration_information_t_basket_idx ON ada_denkmalschutz_oereb.konfiguration_information ( t_basket );
CREATE INDEX konfiguration_information_t_datasetname_idx ON ada_denkmalschutz_oereb.konfiguration_information ( t_datasetname );
COMMENT ON COLUMN ada_denkmalschutz_oereb.konfiguration_information.auszugindex IS 'Ordnungszahl für die Sortierung im Auszug.';
-- OeREBKRMkvs_V2_0.Konfiguration.Logo
CREATE TABLE ada_denkmalschutz_oereb.konfiguration_logo (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX konfiguration_logo_t_basket_idx ON ada_denkmalschutz_oereb.konfiguration_logo ( t_basket );
CREATE INDEX konfiguration_logo_t_datasetname_idx ON ada_denkmalschutz_oereb.konfiguration_logo ( t_datasetname );
COMMENT ON COLUMN ada_denkmalschutz_oereb.konfiguration_logo.acode IS 'ch.plr, ch, ch.{kanton} oder ch.{bfsnr}';
-- OeREBKRMkvs_V2_0.Konfiguration.MapLayering
CREATE TABLE ada_denkmalschutz_oereb.konfiguration_maplayering (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX konfiguration_maplayering_t_basket_idx ON ada_denkmalschutz_oereb.konfiguration_maplayering ( t_basket );
CREATE INDEX konfiguration_maplayering_t_datasetname_idx ON ada_denkmalschutz_oereb.konfiguration_maplayering ( t_datasetname );
-- OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt
CREATE TABLE ada_denkmalschutz_oereb.konfiguration_rechtsstatustxt (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,acode varchar(255) NOT NULL
...
;
CREATE INDEX konfiguration_rchtssttstxt_t_basket_idx ON ada_denkmalschutz_oereb.konfiguration_rechtsstatustxt ( t_basket );
CREATE INDEX konfiguration_rchtssttstxt_t_datasetname_idx ON ada_denkmalschutz_oereb.konfiguration_rechtsstatustxt ( t_datasetname );
COMMENT ON TABLE ada_denkmalschutz_oereb.konfiguration_rechtsstatustxt IS 'Anzeigetexte für die Aufzählung RechtsStatus';
-- OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme
CREATE TABLE ada_denkmalschutz_oereb.metadatenkvs_datenaufnahme (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
  ,datum date NOT NULL
...
;
CREATE INDEX metadatenkvs_datenaufnahme_t_basket_idx ON ada_denkmalschutz_oereb.metadatenkvs_datenaufnahme ( t_basket );
CREATE INDEX metadatenkvs_datenaufnahme_t_datasetname_idx ON ada_denkmalschutz_oereb.metadatenkvs_datenaufnahme ( t_datasetname );
CREATE INDEX metadatenkvs_datenaufnahme_zustaendigestelle_idx ON ada_denkmalschutz_oereb.metadatenkvs_datenaufnahme ( zustaendigestelle );
COMMENT ON TABLE ada_denkmalschutz_oereb.metadatenkvs_datenaufnahme IS 'Angaben zur Datenlieferung an die Katasterorganisation des Kantons.';
COMMENT ON COLUMN ada_denkmalschutz_oereb.metadatenkvs_datenaufnahme.datum IS 'Zeitpunkt der Aufnahme oder der letzten Änderung der Daten';
COMMENT ON COLUMN ada_denkmalschutz_oereb.metadatenkvs_datenaufnahme.datensatzidentifikation IS 'BasketId oder Dateiname oder vollständiger WFS-Request.';
-- OeREBKRMkvs_V2_0.Thema.Thema
CREATE TABLE ada_denkmalschutz_oereb.thema_thema (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX thema_thema_t_basket_idx ON ada_denkmalschutz_oereb.thema_thema ( t_basket );
CREATE INDEX thema_thema_t_datasetname_idx ON ada_denkmalschutz_oereb.thema_thema ( t_datasetname );
COMMENT ON TABLE ada_denkmalschutz_oereb.thema_thema IS 'Anzeigetexte für die Aufzählung Thema';
COMMENT ON COLUMN ada_denkmalschutz_oereb.thema_thema.auszugindex IS 'Ordnungszahl für die Sortierung im Auszug. Bei Subthemen definiert die Ordnungszahl die Reihenfolge innerhalb des Themas.';
-- OeREBKRMkvs_V2_0.Thema.ThemaGesetz
CREATE TABLE ada_denkmalschutz_oereb.thema_themagesetz (
  T_Id bigint PRIMARY KEY DEFAULT nextval('ada_denkmalschutz_oereb.t_ili2db_seq')
  ,T_basket bigint NOT NULL
  ,T_datasetname varchar(200) NOT NULL
...
;
CREATE INDEX thema_themagesetz_t_basket_idx ON ada_denkmalschutz_oereb.thema_themagesetz ( t_basket );
CREATE INDEX thema_themagesetz_t_datasetname_idx ON ada_denkmalschutz_oereb.thema_themagesetz ( t_datasetname );
CREATE INDEX thema_themagesetz_thema_idx ON ada_denkmalschutz_oereb.thema_themagesetz ( thema );
CREATE INDEX thema_themagesetz_gesetz_idx ON ada_denkmalschutz_oereb.thema_themagesetz ( gesetz );
...
;
CREATE TABLE ada_denkmalschutz_oereb.grundstueckart (
  itfCode integer PRIMARY KEY
  ,iliCode varchar(1024) NOT NULL
  ,seq integer NULL
  ,inactive boolean NOT NULL
...
ALTER TABLE ada_denkmalschutz_oereb.artikelnummer_ ADD CONSTRAINT artikelnummer__thema_themagesetz_artiklnr_fkey FOREIGN KEY ( thema_themagesetz_artikelnr ) REFERENCES ada_denkmalschutz_oereb.thema_themagesetz DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ada_denkmalschutz_oereb.multilingualblob ADD CONSTRAINT multilingualblob_konfiguration_logo_bild_fkey FOREIGN KEY ( konfiguration_logo_bild ) REFERENCES ada_denkmalschutz_oereb.konfiguration_logo DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ada_denkmalschutz_oereb.themaref ADD CONSTRAINT themaref_konfigurtn_gmndmtrbk_thmen_fkey FOREIGN KEY ( konfiguratn_gmndmtrebk_themen ) REFERENCES ada_denkmalschutz_oereb.konfiguration_gemeindemitoerebk DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_dokumenttyptxt ADD CONSTRAINT konfiguration_dokmnttyptxt_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_gemeindemitoerebk ADD CONSTRAINT konfiguration_gemendmtrebk_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_gemeindemitoerebk ADD CONSTRAINT konfiguration_gemndmtrebk_gemeinde_check CHECK( gemeinde BETWEEN 1 AND 9999);
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_glossar ADD CONSTRAINT konfiguration_glossar_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_grundbuchkreis ADD CONSTRAINT konfiguration_grndbchkreis_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_grundbuchkreis ADD CONSTRAINT konfiguratin_grndbchkreis_gemeinde_check CHECK( gemeinde BETWEEN 1 AND 9999);
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_grundstueckarttxt ADD CONSTRAINT konfiguratin_grndstckrttxt_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_haftungsausschuss ADD CONSTRAINT konfiguratin_hftngssschuss_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_information ADD CONSTRAINT konfiguration_information_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_information ADD CONSTRAINT konfiguration_information_auszugindex_check CHECK( auszugindex BETWEEN -1000 AND 1000);
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_logo ADD CONSTRAINT konfiguration_logo_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_maplayering ADD CONSTRAINT konfiguration_maplayering_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_maplayering ADD CONSTRAINT konfiguration_maplayering_layerindex_check CHECK( layerindex BETWEEN -1000 AND 1000);
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_maplayering ADD CONSTRAINT konfiguration_maplayering_layerdeckkraft_check CHECK( layerdeckkraft BETWEEN 0.0 AND 1.0);
ALTER TABLE ada_denkmalschutz_oereb.konfiguration_rechtsstatustxt ADD CONSTRAINT konfiguration_rchtssttstxt_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.metadatenkvs_datenaufnahme ADD CONSTRAINT metadatenkvs_datenaufnahme_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.metadatenkvs_datenaufnahme ADD CONSTRAINT metadatenkvs_datenaufnahme_zustaendigestelle_fkey FOREIGN KEY ( zustaendigestelle ) REFERENCES ada_denkmalschutz_oereb.amt_amt DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.thema_thema ADD CONSTRAINT thema_thema_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.thema_thema ADD CONSTRAINT thema_thema_auszugindex_check CHECK( auszugindex BETWEEN -1000 AND 1000);
ALTER TABLE ada_denkmalschutz_oereb.thema_themagesetz ADD CONSTRAINT thema_themagesetz_T_basket_fkey FOREIGN KEY ( T_basket ) REFERENCES ada_denkmalschutz_oereb.T_ILI2DB_BASKET DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.thema_themagesetz ADD CONSTRAINT thema_themagesetz_thema_fkey FOREIGN KEY ( thema ) REFERENCES ada_denkmalschutz_oereb.thema_thema DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE ada_denkmalschutz_oereb.thema_themagesetz ADD CONSTRAINT thema_themagesetz_gesetz_fkey FOREIGN KEY ( gesetz ) REFERENCES ada_denkmalschutz_oereb.vorschriften_dokument DEFERRABLE INITIALLY DEFERRED;
...
;
CREATE UNIQUE INDEX T_ILI2DB_ATTRNAME_ColOwner_SqlName_key ON ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (ColOwner,SqlName)
;
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme','metadatenkvs_datenaufnahme');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK','konfiguration_gemeindemitoerebk');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.ZustaendigeStelleDatenAufnahme','metadatenkvs_zustaendigestelledatenaufnahme');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRM_V2_0.LocalisedBlob','localisedblob');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRM_V2_0.ArtikelNummer_','artikelnummer_');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis','konfiguration_grundbuchkreis');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt','konfiguration_grundstueckarttxt');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Logo','konfiguration_logo');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRM_V2_0.GrundstueckArt','grundstueckart');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema','thema_thema');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss','konfiguration_haftungsausschuss');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt','konfiguration_rechtsstatustxt');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar','konfiguration_glossar');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz','thema_themagesetz');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information','konfiguration_information');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt','konfiguration_dokumenttyptxt');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_CLASSNAME (IliName,SqlName) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering','konfiguration_maplayering');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt.Titel','titel','konfiguration_dokumenttyptxt',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.Los','los','konfiguration_grundbuchkreis',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering.VerweisWMS','verweiswms','konfiguration_maplayering',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRM_V2_0.ArtikelNummer_.value','avalue','artikelnummer_',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering.LayerIndex','layerindex','konfiguration_maplayering',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema.SubCode','subcode','thema_thema',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema.Code','acode','thema_thema',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Logo.Bild','konfiguration_logo_bild','multilingualblob','konfiguration_logo');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar.Titel','titel','konfiguration_glossar',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss.Titel','titel','konfiguration_haftungsausschuss',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.NBIdent','nbident','konfiguration_grundbuchkreis',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema.Titel','titel','thema_thema',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK.GrundlagedatenMetadaten','grundlagedatenmetadaten','konfiguration_gemeindemitoerebk',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt.Code','acode','konfiguration_dokumenttyptxt',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar.Inhalt','inhalt','konfiguration_glossar',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering.LayerDeckkraft','layerdeckkraft','konfiguration_maplayering',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz.Thema','thema','thema_themagesetz','thema_thema');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Logo.Code','acode','konfiguration_logo',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt.Titel','titel','konfiguration_grundstueckarttxt',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.Name','aname','konfiguration_grundbuchkreis',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.Gemeinde','gemeinde','konfiguration_grundbuchkreis',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme.DatensatzIdentifikation','datensatzidentifikation','metadatenkvs_datenaufnahme',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK.Themen','konfiguratn_gmndmtrebk_themen','themaref','konfiguration_gemeindemitoerebk');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss.Inhalt','inhalt','konfiguration_haftungsausschuss',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK.Gemeinde','gemeinde','konfiguration_gemeindemitoerebk',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information.AuszugIndex','auszugindex','konfiguration_information',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.ZustaendigeStelleDatenAufnahme.ZustaendigeStelle','zustaendigestelle','metadatenkvs_datenaufnahme','amt_amt');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt.Code','acode','konfiguration_rechtsstatustxt',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme.Datum','datum','metadatenkvs_datenaufnahme',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.Kanton','kanton','konfiguration_grundbuchkreis',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema.AuszugIndex','auszugindex','thema_thema',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK.BezeichnungUntereinheitGrundbuch','bezeichnunguntereinheitgrundbuch','konfiguration_gemeindemitoerebk',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information.Titel','titel','konfiguration_information',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz.Gesetz','gesetz','thema_themagesetz','vorschriften_dokument');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information.Inhalt','inhalt','konfiguration_information',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis.SubKreis','subkreis','konfiguration_grundbuchkreis',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz.ArtikelNr','thema_themagesetz_artikelnr','artikelnummer_','thema_themagesetz');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK.GrundlagedatenStand','grundlagedatenstand','konfiguration_gemeindemitoerebk',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt.Code','acode','konfiguration_grundstueckarttxt',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_ATTRNAME (IliName,SqlName,ColOwner,Target) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt.Titel','titel','konfiguration_rechtsstatustxt',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information.Inhalt','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.ZustaendigeStelleDatenAufnahme','ch.ehi.ili2db.inheritance','embedded');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRM_V2_0.ArtikelNummer_','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss.Inhalt','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Logo','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar.Inhalt','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt','ch.ehi.ili2db.inheritance','newClass');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt.Titel','ch.ehi.ili2db.multilingualTrafo','expand');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TRAFO (iliname,tag,setting) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering','ch.ehi.ili2db.inheritance','newClass');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.DokumentTypTxt',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.DatenAufnahme',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.MetadatenKVS.ZustaendigeStelleDatenAufnahme',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Information',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Thema.Thema',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GemeindeMitOeREBK',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Glossar',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundbuchKreis',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRM_V2_0.ArtikelNummer_',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Logo',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.RechtsStatusTxt',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Thema.ThemaGesetz',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.Haftungsausschuss',NULL);
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.MapLayering',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_INHERITANCE (thisClass,baseClass) VALUES ('OeREBKRMkvs_V2_0.Konfiguration.GrundstueckArtTxt',NULL);
...
INSERT INTO ada_denkmalschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'Liegenschaft',0,'Liegenschaft',FALSE,NULL);
INSERT INTO ada_denkmalschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SelbstRecht.Baurecht',1,'SelbstRecht.Baurecht',FALSE,NULL);
INSERT INTO ada_denkmalschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SelbstRecht.Quellenrecht',2,'SelbstRecht.Quellenrecht',FALSE,NULL);
INSERT INTO ada_denkmalschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SelbstRecht.Konzessionsrecht',3,'SelbstRecht.Konzessionsrecht',FALSE,NULL);
INSERT INTO ada_denkmalschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'SelbstRecht.weitere',4,'SelbstRecht.weitere',FALSE,NULL);
INSERT INTO ada_denkmalschutz_oereb.grundstueckart (seq,iliCode,itfCode,dispName,inactive,description) VALUES (NULL,'Bergwerk',5,'Bergwerk',FALSE,NULL);
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('themaref',NULL,'konfiguratn_gmndmtrebk_themen','ch.ehi.ili2db.foreignKey','konfiguration_gemeindemitoerebk');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('thema_themagesetz',NULL,'gesetz','ch.ehi.ili2db.foreignKey','vorschriften_dokument');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('thema_themagesetz',NULL,'thema','ch.ehi.ili2db.foreignKey','thema_thema');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('multilingualblob',NULL,'konfiguration_logo_bild','ch.ehi.ili2db.foreignKey','konfiguration_logo');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('artikelnummer_',NULL,'thema_themagesetz_artikelnr','ch.ehi.ili2db.foreignKey','thema_themagesetz');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('metadatenkvs_datenaufnahme',NULL,'zustaendigestelle','ch.ehi.ili2db.foreignKey','amt_amt');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_COLUMN_PROP (tablename,subtype,columnname,tag,setting) VALUES ('multilingualmtext',NULL,'T_Type','ch.ehi.ili2db.types','["localisationch_v1_multilingualmtext","multilingualmtext"]');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('thema_thema','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_dokumenttyptxt','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_logo','ch.ehi.ili2db.tableKind','CLASS');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_maplayering','ch.ehi.ili2db.tableKind','CLASS');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_grundbuchkreis','ch.ehi.ili2db.tableKind','CLASS');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_gemeindemitoerebk','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('metadatenkvs_datenaufnahme','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_haftungsausschuss','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_glossar','ch.ehi.ili2db.tableKind','CLASS');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('thema_themagesetz','ch.ehi.ili2db.tableKind','ASSOCIATION');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_grundstueckarttxt','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_rechtsstatustxt','ch.ehi.ili2db.tableKind','CLASS');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('grundstueckart','ch.ehi.ili2db.tableKind','ENUM');
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_TABLE_PROP (tablename,tag,setting) VALUES ('konfiguration_information','ch.ehi.ili2db.tableKind','CLASS');
...
END OeREBKRMvs_V2_0.
','2020-07-09 18:02:48.751');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('OeREBKRMkvs_V2_0.ili','2.3','OeREBKRMkvs_V2_0{ CHAdminCodes_V1 LocalisationCH_V1 OeREBKRM_V2_0 OeREBKRMvs_V2_0}','INTERLIS 2.3;
...
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('OeREBKRMkvs_V2_0','furtherInformation','https://www.cadastre.ch/oereb-public');
INSERT INTO ada_denkmalschutz_oereb.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('OeREBKRMkvs_V2_0','technicalContact','mailto:vermessung@swisstopo.ch');
